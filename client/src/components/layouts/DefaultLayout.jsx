...
const navigation = [
  ...
  { name: "Tasks", href: "/user/task", icon: ClipboardDocumentListIcon }
];
      ...
      <div>
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-gray-800 pt-5 pb-4">
                  ...
                  <div className="flex flex-shrink-0 text-white  gap-2 items-center px-4">
        ...
        <div className="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
          ...
          <div className="flex min-h-0 flex-1 flex-col bg-gray-800">
            <div className="flex h-16 text-white  gap-2 flex-shrink-0 items-center bg-gray-900 px-4">
            <ClipboardDocumentListIcon className=" h-6 w-6"/>
                    <span>Task Management App</span>
            </div>
